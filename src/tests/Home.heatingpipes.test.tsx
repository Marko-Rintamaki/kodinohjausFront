...
describe('Home Component - Heating Pipe Functionality', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('has heating pipe data model and state management', () => {
    const component = renderHome();
    
    // Component renders successfully (indicating heating pipe state is managed)
    expect(component.container).toBeTruthy();
  ...
  it('has proper heating pipe positioning system', () => {
    const component = renderHome();
  ...
  it('maintains zoom/pan with heating pipe overlay', () => {
    const component = renderHome();
  ...
  it('has proper layer ordering: heating pipes in background', () => {
    const component = renderHome();
